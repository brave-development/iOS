...
//		NSNotificationCenter.defaultCenter().addObserver(self, selector: Selector("finishedGettingPublicHistory"), name:"gotPublicHistory", object: nil)
//		NSNotificationCenter.defaultCenter().addObserver(self, selector: Selector("finishedGettingPrivateHistory"), name:"gotLocalHistory", object: nil)
